...
export const NARRATION_CONFIG = {
  ...
  download: {
    ...
    backupText: [
      ...
      "请在浏览器下载列表中打开已下载的内容。",
      "您刚刚下载并运行的，实际是伪装成软件安装包的木马病毒。您可以在另一台主机上看到，您的主机已经被攻击者控制。为降低风险，请优先通过软件官方网站、正规应用商店或经单位审核的渠道获取安装包。下载前，还应核对访问域名、发布者、数字签名和文件信息。不要仅因搜索结果中的推广位置或页面外观相似就信任下载来源。",
      "",
    ],
  },
  mail: {
    ...
    backupText: [
      ...
      "您刚刚下载并运行的，实际是伪装成软件安装包的木马病毒。您可以在另一台主机上看到，您的主机已经被攻击者控制。为防范钓鱼邮件，应核验发件人与回复地址，核对业务流程与附件类型，并通过独立、可信的渠道向发件单位确认。对可疑邮件和附件，应停止操作，并及时上报安全人员。",
      "",
      "",
    ],
  },
